    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Christofora");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Christofora");
                mPerson.setAge(20);
                mPerson.setEmail("christoforadianayuliawati@gmail.com");
